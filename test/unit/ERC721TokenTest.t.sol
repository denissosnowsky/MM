...
contract ERC721TokenTest is Test {
    ...
    function testHasCommonRoayltyByDefault() public {
        ...
        vm.expectRevert(ERC721Token.ERC721Token__CommonRoyaltyIsOn.selector);
        token.setRoyalties(0, receivers, bps);
    ...
    function testOwnerCanChangeHasCommonRoyalty() public {
        ...
        vm.expectRevert(ERC721Token.ERC721Token__CommonRoyaltyIsOff.selector);
        token.setRoyalties(receivers, bps);
        vm.expectRevert(ERC721Token.ERC721Token__CommonRoyaltyIsOff.selector);
        token.getRoyalties();
        vm.stopPrank();
    ...
    function testOwnerCanChangeHasRoyalty() public {
        ...
        vm.expectRevert(ERC721Token.ERC721Token__RoyaltyIsOff.selector);
        token.setRoyalties(receivers, bps);
        vm.expectRevert(ERC721Token.ERC721Token__RoyaltyIsOff.selector);
        token.setRoyalties(0, receivers, bps);
        vm.stopPrank();
    ...
    function testCantAddRoyaltyToNitMintedToken() public {
        ...
        vm.expectRevert(ERC721Token.ERC721Token__TokenDoesNotExist.selector);
        token.setRoyalties(0, receivers, bps);
        vm.stopPrank();
    }
